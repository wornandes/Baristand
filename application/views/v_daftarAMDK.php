...
<!--educate logos start here-->
	<form role="form" action="daftarAMDK/daftarAMDK" method="post" class="form-group" enctype="multipart/form-data">
	<div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-body">
			...
			<input type="text" name="surat_ijin" class="form-control" required autofocus>
			<input type="file" name="userfile[]" multiple="multiple" class="form-control" placeholder="Browse" required autofocus><br>
			...
			<input type="hidden" name="tipe_jenis" id="tipe_jenis" value="AMDK">
         </div>
