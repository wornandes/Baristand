...
<!--header strat here-->
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form role="form" action="daftarSIR/daftarSIR" method="post" class="form-group" enctype="multipart/form-data">
         <div class="modal-body">
			...
			<br>
            <label>Nama Perusahaan</label><input type="text" name="nama_perusahaan" class="form-control"  required autofocus>
            <label>Alamat Kantor</label><input type="text" name="alamat_kantor" class="form-control" required autofocus>
            <label>Alamat Pabrik</label><input type="text" name="alamat_pabrik" class="form-control" required autofocus>
			...
			<input type="text" name="sistem_manajemen" class="form-control" required autofocus>
			<input type="file" name="userfile[]" multiple="multiple" class="form-control" placeholder="Browse" required autofocus><br>
			<label>Ijin Usaha Industri</label>
			<input type="text" name="ijin_usaha" class="form-control" required autofocus>
			<input type="file" name="userfile[]" multiple="multiple" class="form-control" placeholder="Browse" required autofocus><br>
			<input type="hidden" name="id_user" id="id_user" value="<?php echo $id_user;?>">
			<input type="hidden" name="tipe_jenis" id="tipe_jenis" value="SIR">
