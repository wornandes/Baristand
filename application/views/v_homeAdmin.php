                ...
                <div class="logo">
                 ...
                 <div class="top-nav">
                     ...
                     <nav class="cl-effect-21" id="cl-effect-21">                                                           
                            <ul class="res">
                                <li><a href="/Siamang/homeAdmin" class="active">Home Admin</a></li>
                        ...
                        <div class="ch-item">               
                            <div class="ch-info">
                                ...
                                <div class="ch-info-back">
                                    <!--<img src="gambar/<?php echo $permohonan_key->foto_produk; ?>"style="max-height: 100px"/> -->
...
<div class="modal fade" id="modalTambah" role="dialog">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form role="form" action="permohonan/tambahPermohonan" method="post" class="form-group">
