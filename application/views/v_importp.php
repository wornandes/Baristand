      ...
      <div class="modal-content">
        <form role="form" action="/Siamang/pencarian/pencarianLokasi" method="post">
         ...
         <div class="modal-body">
            <input type="button" onclick="window.location='http://localhost/Siamang/daftarAMDK?id_user=<?php echo $id_user;?>'" class="btn btn-primary" value="AMDK"/><br><br>
            <input type="button" onclick="window.location='http://localhost/Siamang/daftarSIR?id_user=<?php echo $id_user;?>'" class="btn btn--radius-2 btn--red" value="SIR"/><br><br>
			<input type="button" onclick="window.location='http://localhost/Siamang/daftarLain?id_user=<?php echo $id_user;?>'" class="btn btn--radius-2 btn--green" value="Lainnya"/><br>
         </div>
     </div>
	</div>
    </form>
