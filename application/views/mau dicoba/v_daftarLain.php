      ...
      <div class="modal-content">
        <form role="form" action="acara/registrasi" method="post" class="form-group">
         ...
         <div class="modal-body">
			<label>Bentuk Usaha dalam Negeri : </label>
			...
			<input type="file" name="gambar" class="form-control" placeholder="Browse" required autofocus><br>
			<label>Sertifikat Sistem Manajemen Mutu (ISO 9001)</label><input type="text" name="telegram" class="form-control" required autofocus>
			<input type="file" name="gambar" class="form-control" placeholder="Browse" required autofocus><br>
			<label>Ijin Usaha Industri</label><input type="text" name="telegram" class="form-control" required autofocus>
			<input type="file" name="gambar" class="form-control" placeholder="Browse" required autofocus><br>
			<label>Nama Penanggung Jawab Importir</label><input type="text" name="telegram" class="form-control" required autofocus>
			<input type="file" name="gambar" class="form-control" placeholder="Browse" required autofocus><br>
         </div>
