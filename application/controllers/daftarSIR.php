...
class  daftarSIR extends CI_Controller{

	function __construct(){
		parent::__construct();		
		$this->load->model('m_daftarSIR');
	...
	function index(){
		...
		$this->load->view('v_daftarSIR',$data);
	}
    ...
    $data = array(
		...
		'gambarsistem' => $dataInfo[6]['file_name'],
		'gambarijin' => $dataInfo[7]['file_name']
     );
	 $this->m_daftarSIR->daftarSIR($data,'data_perusahaan');
		redirect('login');
	}
